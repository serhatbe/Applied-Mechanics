...
![Addition of Vectors by Nose-to-tail Method](images/Nose_to_tail_method.png){#fig-Nose_to_tail_method}
...
![Addition of Vectors by Parallelogram Method](images/Parallelogram_method.png){#fig-Parallelogram_method}

### Space Diagrams

The space diagram is an illustration of the system of forces.

![Space Diagram](images/spacedia.png){#fig-spacedia fig-align="center" width="75%"}
...
![Vector Diagram](images/vectordia.png){#fig-vectordia fig-align="center"}
...
![Equilibrant](images/vectordiaE.png){#fig-equilibrant fig-align="center"}
...
![Bow’s Notation Space Diagram](images/bowsNotation.png){#fig-BowsNotSpace fig-align="center"}

![Bow’s Notation Vector Diagram](images/bowsNotationVector.png){#fig-BowsNotVec fig-align="center"}
