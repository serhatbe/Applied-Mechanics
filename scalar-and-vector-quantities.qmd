...
-   The **actual speed** is the magnitude of the total velocity vector: $$
    \text{Speed} = \sqrt{v_x^2 + v_y^2} = \sqrt{19.82^2 + 5.67^2} = \sqrt{393.39 + 32.14} = \sqrt{425.53} \approx 20.64 \, \text{knots}
    $$
...
![Ship vs Current diagram](images/ship-current.png){#fig-ship-current}
