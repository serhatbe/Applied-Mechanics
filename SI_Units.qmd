...
-   Recall the based and derived units.
...
### Example of Unity Fraction in Action
...
1.  Use unity fractions to convert between derived SI units.
...
Convert each of the following using unity fractions. Show all steps!
...
9.  $50 \, \text{N} \cdot \text{m} = 0.5 \, \text{kN} \cdot \text{cm}$
10. $500 \, \text{Hz} = 0.5 \, \text{kHz}$

**Challenge Problems**

1.  $20 \, \text{N} \times 5 \, \text{m} = 100 \, \text{J}$
2.  $\text{Kinetic energy} = 1500 \, \text{kg} \times \left(20 \, \text{m/s}\right)^2 / 2 = 300 \, \text{kJ}$
3.  $2 \, \text{kW} \times 3 \, \text{hours} = 21.6 \, \text{MJ}$
4.  $200 \, \text{kPa} \times 0.5 \, \text{m}^2 = 100,000 \, \text{N}$
5.  $0.8 \, \text{g/cm}^3 \times 250 \, \text{cm}^3 = 200 \, \text{g}$
