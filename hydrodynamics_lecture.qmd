...
![Volume flow](images/volumeflow.png){width="6cm" height="1.5cm"}
...
![Mean velocity](images/volumeflow1.png){width="6cm" height="1.8cm"}
...
![Continuity equation](images/continuity_equation.png){width="6cm" height="2cm"}
...
![Example](images/continuity_equation_exm.png){width="6cm"}
...
::: {#exm-conteq3}
Water flows in a pipe with a circular cross-section that varies in area. At all points, the water completely fills the pipe.

A. At one point in the pipe, the radius is 0.16 m. What is the speed of the water at this point if it flows into the pipe at a steady rate of 1.40 m³/s?

B. At another point in the pipe, the water speed is 3.9 m/s. What is the radius of the pipe at this point?

### Part A: Finding water speed at r = 0.16 m

Using the flow rate equation: $\dot{v} = A\cdot C$ where:

-   $\dot{v} = 1.40$ m³/s (flow rate)
-   $A = \pi r^2 = \pi(0.16)^2$ m² (cross-sectional area)
-   $C$ is the velocity we're solving for

$$
C = \frac{\dot{v}}{A} = \frac{1.40}{\pi(0.16)^2} = 17.4\ m/s
$$

### Part B: Finding radius when C = 3.9 m/s

Using the same equation: $\dot{v} = A \cdot C = \pi r^2 \cdot C$

Rearranging to solve for r: $$
r = \sqrt{\frac{\dot{v}}{\pi C}} = \sqrt{\frac{1.40}{\pi(3.9)}} = 0.339\ m
$$

Therefore:

-   At r = 0.16 m, the water speed is 17.4 m/s
-   When the water speed is 3.9 m/s, the radius is 0.339 m
:::
...
![Energy equation](images/energy_equation.png){width="6cm"}
...
![Example](images/energy_equation_exm.png){width="6cm" height="2.5cm"}
...
::: {#exm-power}
A centrifugal pump supplies seawater through a pipe with a diameter of 150 mm at a constant velocity of 1.5 m/s. The seawater is pumped to a height of 6.5 m. The efficiency of the pump is 65%. Taking the density of seawater as 1025 kg/m³, find the output and input power of the pump.

### Solution

1.  Find flow rate ($\dot{v}$):
    -   Area = $\pi(d^2/4) = \pi(0.15^2/4) = 0.0177$ m²
    -   $\dot{v} = C \cdot A = 1.5 \times 0.0177 = 0.0265$ m³/s
2.  Calculate output power:
    -   $P_{out} = \rho g \dot{v}H$
    -   $P_{out} = 1025 \times 9.81 \times 0.0265 \times 6.5$
    -   $P_{out} = 1725.8$ W
3.  Calculate input power:
    -   $\eta=\frac{P_{out}}{P_{in}} \times 100$
    -   $65 = \frac{1725.8}{P_{in}} \times 100$
    -   $P_{in} = \frac{1725.8}{0.65}$
    -   $P_{in} = 2655.1$ W

Therefore:

-   Output power = 1.73 kW
